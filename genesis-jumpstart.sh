...
# This is to avoid using npm install which keeps giving me buggy, updated versions of dependencies
# Not the best practice, but BrowserSync broke on my last three builds
